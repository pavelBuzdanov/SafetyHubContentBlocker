...
class ContentBlockerRequestHandler: NSObject, NSExtensionRequestHandling {
    ...
    func beginRequest(with context: NSExtensionContext) {
        ...
        guard let adsBlockerOn = sharedUserDeafults?.bool(forKey: SharedUserDeafults.Keys.trackBlockerState) else { return }
        ...
        if mainOn {
            if adsBlockerOn {
                ...
                let attachment = NSItemProvider(contentsOf: Bundle.main.url(forResource: "trackListZero", withExtension: "json"))!
