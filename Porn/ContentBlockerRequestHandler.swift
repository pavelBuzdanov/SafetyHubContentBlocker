...
class ContentBlockerRequestHandler: NSObject, NSExtensionRequestHandling {
    ...
    func beginRequest(with context: NSExtensionContext) {
        ...
        guard let adsBlockerOn = sharedUserDeafults?.bool(forKey: SharedUserDeafults.Keys.pornBlockerState) else { return }
        ...
        if mainOn {
            if adsBlockerOn {
                ...
                let attachment = NSItemProvider(contentsOf: Bundle.main.url(forResource: "pornListZero", withExtension: "json"))!
